...
const MODEL_CHOICES = {
  ...
  openrouter: [
    { label: "Llama 3.3 70B", value: "openrouter/meta-llama/llama-3.3-70b-instruct", note: "default" },
    { label: "Claude Sonnet 4.5", value: "openrouter/anthropic/claude-sonnet-4-5" },
  ...
  anthropic: [
    { label: "Claude Sonnet 4.5", value: "claude-sonnet-4-5", note: "default" },
    { label: "Claude Opus 4.1", value: "claude-opus-4-1", note: "most capable" },
    { label: "Claude Haiku 3.5", value: "claude-3-5-haiku-latest", note: "fast, cheap" }
  ],
  gemini: [
    { label: "Gemini 2.0 Flash", value: "gemini/gemini-2.0-flash", note: "default" },
